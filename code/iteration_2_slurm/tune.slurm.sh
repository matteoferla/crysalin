...
$CONDA_PREFIX/bin/python $HOME2/crysalin-redux/repo/code/thread_tune_v2.py $OUTPUT_FOLDER $HOME2/crysalin-redux/pentakaihemimer_renumbered2.pdb --design_cycles 5
